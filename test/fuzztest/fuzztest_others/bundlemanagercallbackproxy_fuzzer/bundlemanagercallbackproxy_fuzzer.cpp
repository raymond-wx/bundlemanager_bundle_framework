...
#include "bundlemanagercallbackproxy_fuzzer.h"
#include "securec.h"
...
bool DoSomethingInterestingWithMyAPI(const char* data, size_t size)
{
    ...
    BundleManagerCallbackProxy bundleManagerCallbackProxy(impl);
    const std::string RpcIdResult(data, size);
    bundleManagerCallbackProxy.OnQueryRpcIdFinished(RpcIdResult);
    return true;
}
}
