...
#include "appservicefwkinstallersendbundlesystemevent_fuzzer.h"
...
bool DoSomethingInterestingWithMyAPI(const char* data, size_t size)
{
    ...
    ErrCode result = 0;
    appServicefwk.SendBundleSystemEvent(hspPaths, BundleEventType::INSTALL, installParam, InstallScene::BOOT, result);
    return true;
}
} // namespace OHOS
