...
const std::string HAP_INCLUDE_SO_FEATURE5 = "hapIncludeso5/hapIncludesoFeature5.hap";
const std::string HAP_INCLUDE_SO_FEATURE6 = "hapIncludeso6/hapIncludesoFeature6.hap";
const std::string HAP_INCLUDE_SO_FEATURE7 = "hapIncludeso7/hapIncludesoFeature7.hap";
const std::string HAP_INCLUDE_SO_FEATURE8 = "hapIncludeso8/hapIncludesoFeature8.hap";
const std::string HAP_INCLUDE_SO_FEATURE9 = "hapIncludeso9/hapIncludesoFeature9.hap";
const std::string HAP_INCLUDE_SO_FEATURE10 = "hapIncludeso10/hapIncludesoFeature10.hap";
...
HWTEST_F(BmsInstallHapSoTest, BMS_Install_Multi_Haps_With_SO_0500, Function | MediumTest | Level1)
{
    ...
    std::vector<std::string> hapPaths;
    hapPaths.emplace_back(THIRD_BUNDLE_PATH + HAP_INCLUDE_SO9);
    hapPaths.emplace_back(THIRD_BUNDLE_PATH + HAP_INCLUDE_SO_FEATURE9);
    auto res = InstallBundles(hapPaths);
    EXPECT_EQ(res, OPERATION_SUCCESS);

    bool ret = CheckFilePath(CODE_ROOT_PATH + BUNDLE_NAME9 + LIBS);
    EXPECT_EQ(ret, false);
    res = UninstallBundle(BUNDLE_NAME9);
    EXPECT_EQ(res, OPERATION_SUCCESS);
...
HWTEST_F(BmsInstallHapSoTest, BMS_Install_Multi_Haps_With_SO_0600, Function | MediumTest | Level1)
{
    ...
    std::vector<std::string> hapPaths;
    hapPaths.emplace_back(THIRD_BUNDLE_PATH + HAP_INCLUDE_SO10);
    hapPaths.emplace_back(THIRD_BUNDLE_PATH + HAP_INCLUDE_SO_FEATURE10);
    auto res = InstallBundles(hapPaths);
    EXPECT_EQ(res, OPERATION_SUCCESS);

    bool ret = CheckFilePath(CODE_ROOT_PATH + BUNDLE_NAME10 + LIBS);
    EXPECT_EQ(ret, true);
    res = UninstallBundle(BUNDLE_NAME10);
    EXPECT_EQ(res, OPERATION_SUCCESS);
    std::cout << "END BMS_Install_Multi_Haps_With_SO_0600" << std::endl;
}
}  // namespace AppExecFwk
