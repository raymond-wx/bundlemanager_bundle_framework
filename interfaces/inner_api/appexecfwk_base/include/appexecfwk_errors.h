...
enum {
    ...
    ERR_APPEXECFWK_INSTALLD_EXTRACT_FAILED = 8519936,
    ERR_APPEXECFWK_RESTORECON_PATH_FAILED = 8519937,
    ERR_APPEXECFWK_INSTALLD_CHANGE_FILE_STAT_FAILED = 8519938,
    ERR_APPEXECFWK_INSTALLD_MOVE_FILE_CROSS_DEV = 8519939,
    ERR_APPEXECFWK_INSTALLD_COPY_DIR_FAILED = 8519940,
    ...
    ERR_APPEXECFWK_ENTERPRISE_CERT_CREATE_FD_ERROR = 8522681,
    ERR_APPEXECFWK_ENTERPRISE_CERT_SEND_FILE_ERROR = 8522682,
    ERR_APPEXECFWK_ENTERPRISE_CERT_WRITE_PARCEL_ERROR = 8522683,
    ERR_APPEXECFWK_ENTERPRISE_CERT_SEND_REQUEST_ERROR = 8522684,
    ERR_APPEXECFWK_ENTERPRISE_CERT_PERMISSION_DENIED = 8522685,
    ERR_APPEXECFWK_ENTERPRISE_CERT_ENABLE_KEY_ERROR = 8522686,
    ERR_APPEXECFWK_ENTERPRISE_CERT_DEVICE_ERROR = 8522687,
    ERR_APPEXECFWK_ENTERPRISE_CERT_EXCEED_MAX_NUM = 8522688,
    ERR_APPEXECFWK_ENTERPRISE_CERT_ALREADY_EXISTS = 8522689,
};
