...
enum {
    ...
    // quick fix errcode
    ERR_APPEXECFWK_QUICK_FIX_INTERNAL_ERROR = APPEXECFWK_BUNDLEMGR_ERR_OFFSET + 0x0401, // 8520705
    ERR_APPEXECFWK_QUICK_FIX_PARAM_ERROR,
    ERR_APPEXECFWK_QUICK_FIX_PROFILE_PARSE_FAILED,
    ERR_APPEXECFWK_QUICK_FIX_BUNDLE_NAME_NOT_SAME,
    ERR_APPEXECFWK_QUICK_FIX_VERSION_CODE_NOT_SAME,
    ERR_APPEXECFWK_QUICK_FIX_VERSION_NAME_NOT_SAME,
    ERR_APPEXECFWK_QUICK_FIX_PATCH_VERSION_CODE_NOT_SAME,
    ERR_APPEXECFWK_QUICK_FIX_PATCH_VERSION_NAME_NOT_SAME,
    ERR_APPEXECFWK_QUICK_FIX_PATCH_TYPE_NOT_SAME,
    ERR_APPEXECFWK_QUICK_FIX_MODULE_NAME_SAME,
    ERR_APPEXECFWK_QUICK_FIX_UNKNOWN_QUICK_FIX_TYPE,
    ERR_APPEXECFWK_QUICK_FIX_SO_INCOMPATIBLE,
    ERR_APPEXECFWK_QUICK_FIX_BUNDLE_NAME_NOT_EXIST,
    ERR_APPEXECFWK_QUICK_FIX_MODULE_NAME_NOT_EXIST,
    ERR_APPEXECFWK_QUICK_FIX_SIGNATURE_INFO_NOT_SAME,
    ERR_APPEXECFWK_QUICK_FIX_ADD_HQF_FAILED,
    ERR_APPEXECFWK_QUICK_FIX_SAVE_APP_QUICK_FIX_FAILED,
    ERR_APPEXECFWK_QUICK_FIX_VERSION_CODE_ERROR,
    ERR_APPEXECFWK_QUICK_FIX_EXTRACT_DIFF_FILES_FAILED,
    ERR_APPEXECFWK_QUICK_FIX_APPLY_DIFF_PATCH_FAILED,
    ERR_APPEXECFWK_QUICK_FIX_NO_PATCH_IN_DATABASE,
    ERR_APPEXECFWK_QUICK_FIX_INVALID_PATCH_STATUS,
    ERR_APPEXECFWK_QUICK_FIX_NOT_EXISTED_BUNDLE_INFO,
    ERR_APPEXECFWK_QUICK_FIX_REMOVE_PATCH_SO_PATH_FAILED,
    ERR_APPEXECFWK_QUICK_FIX_HOT_RELOAD_NOT_SUPPORT_RELEASE_BUNDLE,
    ERR_APPEXECFWK_QUICK_FIX_PATCH_ALREADY_EXISTED,
    ERR_APPEXECFWK_QUICK_FIX_HOT_RELOAD_ALREADY_EXISTED,
    ERR_APPEXECFWK_QUICK_FIX_NO_PATCH_INFO_IN_BUNDLE_INFO,

    ERR_APPEXECFWK_APP_CONTROL_INTERNAL_ERROR = APPEXECFWK_BUNDLEMGR_ERR_OFFSET + 0x0501, // 8520961
    ERR_APPEXECFWK_APP_CONTROL_PERMISSION_DENIED,
    ERR_APPEXECFWK_APP_CONTROL_DISENABLE,
    ERR_APPEXECFWK_APP_CONTROL_RDB_DISENABLE
};
