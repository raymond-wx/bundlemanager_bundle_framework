...
enum {
    ...
    ERR_APPEXECFWK_INSTALL_VERIFY_APP_SIGNATURE_FAILED = 8522653,
    ERR_APPEXECFWK_INSTALL_DECOMPRESS_APP_FAILED = 8522654,
    ERR_APPEXECFWK_INSTALL_NO_SUITABLE_BUNDLES = 8522655,
};
