...
enum {
    ...
    // Dynamic icon
    ERR_BUNDLE_MANAGER_DYNAMIC_ICON_PARAM_ERROR = 8521900,
    ERR_BUNDLE_MANAGER_DYNAMIC_ICON_CREATE_FD_FAILED = 8521901,
    ERR_BUNDLE_MANAGER_DYNAMIC_ICON_INVALID_TARGET_DIR = 8521902,
    ERR_BUNDLE_MANAGER_DYNAMIC_ICON_INVALID_PATH = 8521903,
    ERR_BUNDLE_MANAGER_DYNAMIC_ICON_OPEN_SOURCE_FILE_FAILED = 8521904,
    ERR_BUNDLE_MANAGER_DYNAMIC_ICON_WRITE_FILE_FAILED = 8521905,
    ERR_BUNDLE_MANAGER_DYNAMIC_ICON_GET_DYNAMIC_ICON_MGR_FAILED = 8521906,
};
