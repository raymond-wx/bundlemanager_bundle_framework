...
enum {
    ...
    ERR_APPEXECFWK_CLONE_INSTALL_INVALID_APP_INDEX = 85220007,
    ERR_APPEXECFWK_CLONE_INSTALL_NOT_INSTALLED_AT_SPECIFIED_USERID = 85220008,
    ERR_APPEXECFWK_CLONE_INSTALL_GET_PERMISSIONS_FAILED = 85220009,
    ERR_APPEXECFWK_CLONE_INSTALL_APP_INDEX_EXISTED = 85220010,

    // clone app query
    ERR_APPEXECFWK_CLONE_QUERY_PARAM_ERROR = 85220100,
    ERR_APPEXECFWK_CLONE_QUERY_INTERNAL_ERROR = 85220101,
    ERR_APPEXECFWK_CLONE_QUERY_INVALID_USER_ID = 85220102,
    ERR_APPEXECFWK_CLONE_QUERY_NO_CLONE_APP = 85220103,
    ERR_APPEXECFWK_CLONE_QUERY_NO_MODULE_INFO = 85220104,
    ERR_APPEXECFWK_CLONE_QUERY_NO_USER_INFO = 85220105,
};
