...
enum {
    ...
    ERR_BUNDLEMANAGER_APP_CONTROL_INTERNAL_ERROR = APPEXECFWK_BUNDLEMGR_ERR_OFFSET + 0x0501, // 8520961
    ERR_BUNDLEMANAGER_APP_CONTROL_PERMISSION_DENIED,
    ERR_BUNDLEMANAGER_APP_CONTROL_DISENABLE,
    ERR_BUNDLEMANAGER_APP_CONTROL_RDB_DISENABLE,
    // query errcode
    ERR_BUNDLE_MANAGER_QUERY_INTERNAL_ERROR = APPEXECFWK_BUNDLEMGR_ERR_OFFSET + 0x0601, // 8521217
    ERR_BUNDLE_MANAGER_QUERY_INVALID_USER_ID,
    ERR_BUNDLE_MANAGER_QUERY_BUNDLE_NOT_EXIST,
    ERR_BUNDLE_MANAGER_QUERY_ABILITY_NOT_EXIST,
    ERR_BUNDLE_MANAGER_QUERY_ABILITY_DISABLED,
