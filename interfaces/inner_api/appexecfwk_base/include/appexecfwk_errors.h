...
enum {
    ...
    // Dynamic icon
    ERR_EXT_RESOURCE_MANAGER_PARAM_ERROR = 8521900,
    ERR_EXT_RESOURCE_MANAGER_CREATE_FD_FAILED = 8521901,
    ERR_EXT_RESOURCE_MANAGER_INVALID_TARGET_DIR = 8521902,
    ERR_EXT_RESOURCE_MANAGER_GET_EXT_RESOURCE_MGR_FAILED = 8521903,
    ERR_EXT_RESOURCE_MANAGER_BUNDLE_NOT_EXIST = 8521904,
    ERR_EXT_RESOURCE_MANAGER_PARSE_FILE_FAILED = 8521905,
    ERR_EXT_RESOURCE_MANAGER_REMOVE_MODULE_NOT_EXIST = 8521906,
    ERR_EXT_RESOURCE_MANAGER_GET_FAILED = 8521907,
    ERR_EXT_RESOURCE_MANAGER_COPY_FILE_FAILED = 8521908,
};
