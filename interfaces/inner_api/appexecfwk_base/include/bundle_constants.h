...
const std::string SYSTEM_APP_INSTALL_PATH = "/data/app/el1/bundle/public";
const std::string THIRD_SYSTEM_APP_SCAN_PATH = "/system/vendor";
const std::string THIRD_SYSTEM_APP_INSTALL_PATH = "/data/app/el1/bundle/public";
const std::string THIRD_PARTY_APP_INSTALL_PATH = "/data/app/el1/bundle/public";
