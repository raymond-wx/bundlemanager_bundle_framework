...
enum ExtensionAbilityInfoFlagV9 {
    GET_EXTENSION_ABILITY_INFO_DEFAULT_V9 = 0x00000000,
    GET_EXTENSION_ABILITY_INFO_WITH_PERMISSION_V9 = 0x00000001,
    GET_EXTENSION_ABILITY_INFO_WITH_APPLICATION_V9 = 0x00000002,
    GET_EXTENSION_ABILITY_INFO_WITH_METADATA_V9 = 0x00000004,
};
