...
void from_json(const nlohmann::json &jsonObject, Result &result)
{
    ...
    if (parseResult != ERR_OK) {
        LOG_E(BMSTag::FREE_INSTALL, "read module result from jsonObject error, error code : %{public}d", parseResult);
    }
}
...
void from_json(const nlohmann::json &jsonObject, Progress &progress)
{
    ...
    GetValueIfFindKey<std::uint32_t>(jsonObject,
        ...
        ArrayType::NOT_ARRAY);
    if (parseResult != ERR_OK) {
        LOG_E(BMSTag::FREE_INSTALL, "read module progress from jsonObject error, error code : %{public}d", parseResult);
    }
}
...
void from_json(const nlohmann::json &jsonObject, InstallResult &installResult)
{
    ...
    GetValueIfFindKey<Progress>(jsonObject,
        ...
        ArrayType::NOT_ARRAY);
    if (parseResult != ERR_OK) {
        LOG_E(BMSTag::FREE_INSTALL, "read module installResult from jsonObject error: %{public}d", parseResult);
    }
}
