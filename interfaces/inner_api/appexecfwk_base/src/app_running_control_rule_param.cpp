...
AppRunningControlRuleParam *AppRunningControlRuleParam::Unmarshalling(Parcel &parcel)
{
    AppRunningControlRuleParam *info = new (std::nothrow) AppRunningControlRuleParam();
