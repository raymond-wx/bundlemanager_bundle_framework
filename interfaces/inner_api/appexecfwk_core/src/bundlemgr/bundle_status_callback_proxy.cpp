...
void BundleStatusCallbackProxy::InitResultMap()
{
    resultMap_ = {
        ...
        "ERR_APPEXECFWK_INSTALL_SELF_UPDATE_BUNDLENAME_NOT_SAME"},
        {ERR_APPEXECFWK_INSTALL_GWP_ASAN_ENABLED_NOT_SAME, "ERR_APPEXECFWK_INSTALL_GWP_ASAN_ENABLED_NOT_SAME"},
        ...
        {ERR_BUNDLE_MANAGER_CODE_SIGNATURE_DELIVERY_FILE_FAILED, "ERR_BUNDLE_MANAGER_CODE_SIGNATURE_DELIVERY_FILE_FAILED"},
