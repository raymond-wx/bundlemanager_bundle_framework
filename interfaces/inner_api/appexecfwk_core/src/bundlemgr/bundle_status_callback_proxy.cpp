...
void BundleStatusCallbackProxy::InitResultMap()
{
    resultMap_ = {
        ...
        {ERR_APPEXECFWK_INSTALL_APP_SIGNATURE_INCOMPATIBLE, "ERR_APPEXECFWK_INSTALL_APP_SIGNATURE_INCOMPATIBLE"},
        ...
        {ERR_APPEXECFWK_USER_CREATE_FALIED, "ERR_APPEXECFWK_USER_CREATE_FALIED"},
        {ERR_APPEXECFWK_USER_REMOVE_FALIED, "ERR_APPEXECFWK_USER_REMOVE_FALIED"},
