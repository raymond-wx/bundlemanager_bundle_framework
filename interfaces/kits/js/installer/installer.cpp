...
static void CreateErrCodeMap(std::unordered_map<int32_t, int32_t> &errCodeMap)
{
    errCodeMap = {
        ...
        { IStatusReceiver::ERR_INSTALLD_CREATE_DIR_FAILED, ERROR_SYSTEM_IO_OPERATION },
        { IStatusReceiver::ERR_INSTALLD_CHOWN_FAILED, ERROR_SYSTEM_IO_OPERATION },
        { IStatusReceiver::ERR_INSTALLD_CREATE_DIR_EXIST, ERROR_SYSTEM_IO_OPERATION },
        { IStatusReceiver::ERR_INSTALLD_REMOVE_DIR_FAILED, ERROR_SYSTEM_IO_OPERATION },
        { IStatusReceiver::ERR_INSTALLD_EXTRACT_FILES_FAILED, ERROR_SYSTEM_IO_OPERATION },
        { IStatusReceiver::ERR_INSTALLD_RNAME_DIR_FAILED, ERROR_SYSTEM_IO_OPERATION },
        { IStatusReceiver::ERR_INSTALLD_CLEAN_DIR_FAILED, ERROR_SYSTEM_IO_OPERATION },
