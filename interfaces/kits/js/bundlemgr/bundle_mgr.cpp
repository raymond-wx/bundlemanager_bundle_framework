...
namespace {
constexpr uint8_t NAPI_ERR_NO_ERROR = 0;
constexpr uint8_t ARGS_ASYNC_COUNT = 1;
constexpr uint8_t ARGS_MAX_COUNT = 10;
constexpr uint8_t CALLBACK_SIZE = 1;
constexpr int8_t PARAM0 = 0;
constexpr int8_t PARAM1 = 1;
constexpr int8_t PARAM2 = 2;
constexpr int8_t PARAM3 = 3;
constexpr int8_t NAPI_RETURN_FAILED = -1;
constexpr int8_t NAPI_RETURN_ZERO = 0;
constexpr int8_t NAPI_RETURN_TWO = 2;
constexpr int8_t NAPI_RETURN_THREE = 3;
constexpr int8_t CODE_SUCCESS = 0;
constexpr int8_t CODE_FAILED = -1;
constexpr int8_t OPERATION_FAILED = 1;
constexpr int8_t INVALID_PARAM = 2;
constexpr int8_t PARAM_TYPE_ERROR = 1;
constexpr int8_t UNDEFINED_ERROR = -1;
