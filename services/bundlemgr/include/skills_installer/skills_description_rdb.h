...
#ifndef FOUNDATION_APPEXECFWK_SERVICES_BUNDLEMGR_INCLUDE_SKILLS_INSTALLER_SKILLS_DESCRIPTION_RDB_H
#define FOUNDATION_APPEXECFWK_SERVICES_BUNDLEMGR_INCLUDE_SKILLS_INSTALLER_SKILLS_DESCRIPTION_RDB_H
...
class SkillsDescriptionRdb {
public:
    SkillsDescriptionRdb();
    ~SkillsDescriptionRdb();
...
#endif // FOUNDATION_APPEXECFWK_SERVICES_BUNDLEMGR_INCLUDE_SKILLS_INSTALLER_SKILLS_DESCRIPTION_RDB_H
