...
#ifndef FOUNDATION_APPEXECFWK_SERVICES_BUNDLEMGR_INCLUDE_PRIVILEGE_EXTENSION_ABILITY_TYPE_H
#define FOUNDATION_APPEXECFWK_SERVICES_BUNDLEMGR_INCLUDE_PRIVILEGE_EXTENSION_ABILITY_TYPE_H
