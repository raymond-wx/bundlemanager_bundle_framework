...
class IShortcutDataStorage {
public:
    IShortcutDataStorage() = default;
    virtual ~IShortcutDataStorage() = default;
    virtual bool AddDesktopShortcutInfo(const ShortcutInfo &shortcutInfo, int32_t userId, bool &isIdIllegal) = 0;
    virtual bool DeleteDesktopShortcutInfo(const ShortcutInfo &shortcutInfo, int32_t userId) = 0;
...
#endif  // FOUNDATION_APPEXECFWK_SERVICES_BUNDLEMGR_INCLUDE_SHORTCUT_DATA_STORAGE_INTERFACE_H