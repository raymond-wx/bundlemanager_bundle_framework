...
const char* BUNDLE_STATUS = "bundleStatus";
const char* BASE_APPLICATION_INFO = "baseApplicationInfo";
const char* BASE_BUNDLE_INFO = "baseBundleInfo";
const char* BASE_ABILITY_INFO = "baseAbilityInfos";
const char* INNER_MODULE_INFO = "innerModuleInfos";
const char* SKILL_INFOS = "skillInfos";
const char* USER_ID = "userId_";
const char* APP_FEATURE = "appFeature";
const char* NAME = "name";
const char* MODULE_PACKAGE = "modulePackage";
const char* MODULE_PATH = "modulePath";
const char* MODULE_NAME = "moduleName";
const char* MODULE_DESCRIPTION = "description";
const char* MODULE_DESCRIPTION_ID = "descriptionId";
const char* MODULE_ICON = "icon";
const char* MODULE_ICON_ID = "iconId";
const char* MODULE_LABEL = "label";
const char* MODULE_LABEL_ID = "labelId";
const char* MODULE_DESCRIPTION_INSTALLATION_FREE = "installationFree";
const char* MODULE_IS_REMOVABLE = "isRemovable";
const char* MODULE_UPGRADE_FLAG = "upgradeFlag";
const char* MODULE_IS_ENTRY = "isEntry";
const char* MODULE_METADATA = "metaData";
const char* MODULE_HNP_PACKAGE = "hnpPackage";
const char* MODULE_COLOR_MODE = "colorMode";
const char* MODULE_DISTRO = "distro";
const char* MODULE_REQ_CAPABILITIES = "reqCapabilities";
const char* MODULE_DATA_DIR = "moduleDataDir";
const char* MODULE_RES_PATH = "moduleResPath";
const char* MODULE_HAP_PATH = "hapPath";
const char* MODULE_ABILITY_KEYS = "abilityKeys";
const char* MODULE_SKILL_KEYS = "skillKeys";
const char* MODULE_FORMS = "formInfos";
const char* MODULE_SHORTCUT = "shortcutInfos";
const char* MODULE_COMMON_EVENT = "commonEvents";
const char* MODULE_MAIN_ABILITY = "mainAbility";
const char* MODULE_ENTRY_ABILITY_KEY = "entryAbilityKey";
const char* MODULE_DEPENDENCIES = "dependencies";
const char* MODULE_IS_LIB_ISOLATED = "isLibIsolated";
const char* MODULE_NATIVE_LIBRARY_PATH = "nativeLibraryPath";
const char* MODULE_CPU_ABI = "cpuAbi";
const char* MODULE_SRC_PATH = "srcPath";
const char* MODULE_HASH_VALUE = "hashValue";
const char* PORT_SEPARATOR = ":";
const char* INSTALL_MARK = "installMark";
const char* INNER_BUNDLE_USER_INFOS = "innerBundleUserInfos";
const char* MODULE_PROCESS = "process";
const char* MODULE_SRC_ENTRANCE = "srcEntrance";
...
const char* MODULE_META_DATA = "metadata";
const char* MODULE_REQUEST_PERMISSIONS = "requestPermissions";
const char* MODULE_DEFINE_PERMISSIONS = "definePermissions";
const char* MODULE_EXTENSION_KEYS = "extensionKeys";
const char* MODULE_EXTENSION_SKILL_KEYS = "extensionSkillKeys";
const char* MODULE_IS_MODULE_JSON = "isModuleJson";
const char* MODULE_IS_STAGE_BASED_MODEL = "isStageBasedModel";
const char* BUNDLE_IS_NEW_VERSION = "isNewVersion";
const char* BUNDLE_BASE_EXTENSION_INFOS = "baseExtensionInfos";
const char* BUNDLE_EXTENSION_SKILL_INFOS = "extensionSkillInfos";
const char* BUNDLE_EXTEND_RESOURCES = "extendResources";
const char* CUR_DYNAMIC_ICON_MODULE = "curDynamicIconModule";
const char* BUNDLE_PACK_INFO = "bundlePackInfo";
const char* ALLOWED_ACLS = "allowedAcls";
const char* META_DATA_SHORTCUTS_NAME = "ohos.ability.shortcuts";
const char* APP_INDEX = "appIndex";
const char* BUNDLE_IS_SANDBOX_APP = "isSandboxApp";
const char* MODULE_COMPILE_MODE = "compileMode";
const char* BUNDLE_HQF_INFOS = "hqfInfos";
const char* MODULE_TARGET_MODULE_NAME = "targetModuleName";
const char* MODULE_TARGET_PRIORITY = "targetPriority";
const char* MODULE_OVERLAY_MODULE_INFO = "overlayModuleInfo";
const char* OVERLAY_BUNDLE_INFO = "overlayBundleInfo";
const char* OVERLAY_TYPE = "overlayType";
const char* APPLY_QUICK_FIX_FREQUENCY = "applyQuickFixFrequency";
const char* MODULE_PRELOADS = "preloads";
const char* INNER_SHARED_MODULE_INFO = "innerSharedModuleInfos";
const char* MODULE_BUNDLE_TYPE = "bundleType";
const char* MODULE_VERSION_CODE = "versionCode";
const char* MODULE_VERSION_NAME = "versionName";
const char* MODULE_PROXY_DATAS = "proxyDatas";
const char* MODULE_BUILD_HASH = "buildHash";
const char* MODULE_ISOLATION_MODE = "isolationMode";
const char* MODULE_COMPRESS_NATIVE_LIBS = "compressNativeLibs";
const char* MODULE_NATIVE_LIBRARY_FILE_NAMES = "nativeLibraryFileNames";
const char* MODULE_AOT_COMPILE_STATUS = "aotCompileStatus";
const char* DATA_GROUP_INFOS = "dataGroupInfos";
const char* MODULE_FILE_CONTEXT_MENU = "fileContextMenu";
const char* MODULE_IS_ENCRYPTED = "isEncrypted";
const char* MODULE_ROUTER_MAP = "routerMap";
const char* EXT_RESOURCE_MODULE_NAME = "moduleName";
const char* EXT_RESOURCE_ICON_ID = "iconId";
const char* EXT_RESOURCE_FILE_PATH = "filePath";
const char* DEVELOPER_ID = "developerId";
const char* ODID = "odid";
const char* UNINSTALL_STATE = "uninstallState";
...
const char* NATIVE_LIBRARY_PATH_SYMBOL = "!/";

const char* MODULE_QUERY_SCHEMES = "querySchemes";
const char* MODULE_APP_ENVIRONMENTS = "appEnvironments";
const char* MODULE_ASAN_ENABLED = "asanEnabled";
const char* MODULE_GWP_ASAN_ENABLED = "gwpAsanEnabled";
const char* MODULE_PACKAGE_NAME = "packageName";
const char* MODULE_APP_STARTUP = "appStartup";
