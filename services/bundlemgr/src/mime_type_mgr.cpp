...
void MimeTypeMgr::InitMimeMap()
{
    ...
    mimeTypeMap_.emplace("apk", "application/vnd.android.package-archive");
    ...
    mimeTypeMap_.emplace("odm", "application/vnd.oasis.opendocument.text-master");
    ...
    mimeTypeMap_.emplace("kml", "application/vnd.google-earth.kml+xml");
    mimeTypeMap_.emplace("kmz", "application/vnd.google-earth.kmz");
    ...
    mimeTypeMap_.emplace("art", "image/x-jg");
