...
const char* SPLIT = "/";
const char* EMAIL_ACTION = "ohos.want.action.sendToData";
const char* EMAIL_SCHEME = "mailto";
const char* ENTITY_BROWSER = "entity.system.browsable";
