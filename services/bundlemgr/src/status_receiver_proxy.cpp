...
const char* MSG_ERR_INSTALL_DEPENDENT_MOUULE_NOT_EXIST = "[MSG_ERR_INSTALL_DEPENDENT_MOUULE_NOT_EXIST]";
...
const std::map<int32_t, struct ReceivedResult> MAP_RECEIVED_RESULTS {
    ...
    {ERR_APPEXECFWK_INSTALL_DEPENDENT_MOUULE_NOT_EXIST,
        {IStatusReceiver::ERR_INSTALL_DEPENDENT_MOUULE_NOT_EXIST, MSG_ERR_INSTALL_DEPENDENT_MOUULE_NOT_EXIST}}
};
}  // namespace
