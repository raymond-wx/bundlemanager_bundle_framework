...
const char* MSG_ERR_APPEXECFWK_INSTALL_FORCE_UNINSTALLED_BUNDLE_NOT_ALLOW_RECOVER =
    "[MSG_ERR_APPEXECFWK_INSTALL_FORCE_UNINSTALLED_BUNDLE_NOT_ALLOW_RECOVER]";
...
const char* MSG_ERR_INSTALL_BUNDLE_EXISTED_IN_U1_AND_OTHER_USERS  =
    "[MSG_ERR_INSTALL_BUNDLE_EXISTED_IN_U1_AND_OTHER_USERS]";
...
const std::unordered_map<int32_t, struct ReceivedResult> MAP_RECEIVED_RESULTS {
    ...
    {ERR_APPEXECFWK_INSTALL_APP_DISTRIBUTION_TYPE_NOT_SAME,
        {IStatusReceiver::ERR_INSTALL_APP_DISTRIBUTION_TYPE_NOT_SAME,
            MSG_ERR_INSTALL_APP_DISTRIBUTION_TYPE_NOT_SAME}},
    ...
    {ERR_APPEXECFWK_INSTALL_U1ENABLE_CAN_ONLY_INSTALL_IN_U1_WITH_NOT_SINGLETON,
        {IStatusReceiver::ERR_INSTALL_U1ENABLE_CAN_ONLY_INSTALL_IN_U1_WITH_NOT_SINGLETON,
            MSG_ERR_INSTALL_U1ENABLE_CAN_ONLY_INSTALL_IN_U1_WITH_NOT_SINGLETON}},
    {ERR_APPEXECFWK_INSTALL_BUNDLE_EXISTED_IN_U1_AND_OTHER_USERS,
