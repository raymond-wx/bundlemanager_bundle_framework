...
const char* MSG_ERR_UNINSTALLSHARE_APP_LIBRARY_IS_RELIED = "[ERR_UNINSTALLSHARE_APP_LIBRARY_IS_RELIED]";
...
const char* MSG_ERR_INSTALL_ATOMIC_SERVICE_NOT_SAME = "[ERR_INSTALL_ATOMIC_SERVICE_NOT_SAME]";
...
const std::map<int32_t, struct ReceivedResult> MAP_RECEIVED_RESULTS {
    ...
    {ERR_APPEXECFWK_ATOMIC_SERVICE_NOT_SAME,
        {IStatusReceiver::ERR_INSTALL_ATOMIC_SERVICE_NOT_SAME, MSG_ERR_INSTALL_ATOMIC_SERVICE_NOT_SAME}},
    ...
    {ERR_APPEXECFWK_UNINSTALL_SHARE_APP_LIBRARY_IS_RELIED,
        {IStatusReceiver::ERR_APPEXECFWK_UNINSTALL_SHARE_APP_LIBRARY_IS_RELIED,
            MSG_ERR_UNINSTALLSHARE_APP_LIBRARY_IS_RELIED}},
