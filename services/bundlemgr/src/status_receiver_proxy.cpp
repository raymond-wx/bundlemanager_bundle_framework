...
const char* MSG_ERR_INSTALL_APP_SIGNATURE_INCOMPATIBLE = "[MSG_ERR_INSTALL_APP_SIGNATURE_INCOMPATIBLE]";
...
const char* MSG_ERR_USER_CREATE_FALIED = "[ERR_USER_CREATE_FALIED]";
const char* MSG_ERR_USER_REMOVE_FALIED = "[ERR_USER_REMOVE_FALIED]";
...
const std::map<int32_t, struct ReceivedResult> MAP_RECEIVED_RESULTS {
    ...
    {ERR_APPEXECFWK_INSTALL_APP_SIGNATURE_INCOMPATIBLE,
        {IStatusReceiver::ERR_INSTALL_APP_SIGNATURE_INCOMPATIBLE, MSG_ERR_INSTALL_APP_SIGNATURE_INCOMPATIBLE}},
