...
const char* MSG_ERR_INSTALL_PGO_FILE_IS_INVALID = "[MSG_ERR_INSTALL_PGO_FILE_IS_INVALID]";
...
const int32_t MAP_RECEIVED_RESULTS_KEY[] = {
    ERR_OK,
    ...
    ERR_APPEXECFWK_INSTALL_GWP_ASAN_ENABLED_NOT_SAME,
...
const struct ReceivedResult MAP_RECEIVED_RESULTS_VALUE = {
    {IStatusReceiver::SUCCESS,MSG_SUCCESS},
    ...
    {IStatusReceiver::ERR_INSTALL_FAILED_INVALID_SIGNATURE_FILE_PATH,MSG_ERR_INSTALL_FAILED_INVALID_SIGNATURE_FILE_PATH},
    {IStatusReceiver::ERR_INSTALL_FAILED_BAD_BUNDLE_SIGNATURE_FILE,MSG_ERR_INSTALL_FAILED_BAD_BUNDLE_SIGNATURE_FILE},
    ...
    {IStatusReceiver::ERR_INSTALL_FAILED_BUNDLE_INTEGRITY_VERIFICATION_FAILURE,MSG_ERR_INSTALL_FAILED_BUNDLE_INTEGRITY_VERIFICATION_FAILURE},
    ...
    {IStatusReceiver::ERR_INSTALL_FAILED_BUNDLE_SIGNATURE_VERIFICATION_FAILURE,MSG_ERR_INSTALL_FAILED_BUNDLE_SIGNATURE_VERIFICATION_FAILURE},
    ...
    {IStatusReceiver::ERR_INSTALL_MINCOMPATIBLE_VERSIONCODE_NOT_SAME,MSG_ERR_INSTALL_MINCOMPATIBLE_VERSIONCODE_NOT_SAME},
    ...
    {IStatusReceiver::ERR_INSTALL_RELEASETYPE_COMPATIBLE_NOT_SAME,MSG_ERR_INSTALL_RELEASETYPE_COMPATIBLE_NOT_SAME},
    {IStatusReceiver::ERR_INSTALL_APP_DISTRIBUTION_TYPE_NOT_SAME,MSG_ERR_INSTALL_APP_DISTRIBUTION_TYPE_NOT_SAME},
    {IStatusReceiver::ERR_INSTALL_APP_PROVISION_TYPE_NOT_SAME,MSG_ERR_INSTALL_APP_PROVISION_TYPE_NOT_SAME},
    ...
    {IStatusReceiver::ERR_INSTALL_GRANT_REQUEST_PERMISSIONS_FAILED,MSG_ERR_INSTALL_GRANT_REQUEST_PERMISSIONS_FAILED},
    ...
    {IStatusReceiver::ERR_INSTALL_TYPE_ERROR,MSG_ERR_INSTALL_TYPE_ERROR},
    {IStatusReceiver::ERR_INSTALL_SDK_INCOMPATIBLE,MSG_ERR_INSTALL_SDK_INCOMPATIBLE},
    {IStatusReceiver::ERR_INSTALL_SO_INCOMPATIBLE,MSG_ERR_INSTALL_SO_INCOMPATIBLE},
    ...
    {IStatusReceiver::ERR_INSTALL_PARSE_PROFILE_PROP_SIZE_CHECK_ERROR,MSG_ERR_INSTALL_PARSE_PROFILE_PROP_SIZE_CHECK_ERROR},
    ...
    {IStatusReceiver::ERR_INSTALL_ASAN_ENABLED_NOT_SAME,MSG_ERR_ASAN_ENABLED_NOT_SAME},
    {IStatusReceiver::ERR_INSTALL_ASAN_ENABLED_NOT_SUPPORT,MSG_ERR_ASAN_ENABLED_NOT_SUPPORT},
    ...
    {IStatusReceiver::ERR_INSTALLD_CHOWN_FAILED,MSG_ERR_INSTALLD_CHOWN_FAILED},
    ...
    {IStatusReceiver::ERR_INSTALLD_PARAM_ERROR,MSG_ERR_INSTALLD_PARAM_ERROR},
    {IStatusReceiver::ERR_INSTALLD_PERMISSION_DENIED,MSG_ERR_INSTALLD_PERMISSION_DENIED},
    {IStatusReceiver::ERR_INSTALLD_SET_SELINUX_LABEL_FAILED,MSG_ERR_INSTALLD_SET_SELINUX_LABEL_FAILED},
    {IStatusReceiver::ERR_UNINSTALL_MISSING_INSTALLED_MODULE,MSG_ERR_UNINSTALL_MISSING_INSTALLED_MODULE},
    {IStatusReceiver::ERR_UNINSTALL_PARAM_ERROR,MSG_ERR_UNINSTALL_PARAM_ERROR},
    ...
    {IStatusReceiver::ERR_RECOVER_NOT_ALLOWED,MSG_ERR_RECOVER_NOT_ALLOWED},
    {IStatusReceiver::ERR_UNINSTALL_AND_RECOVER_NOT_PREINSTALLED_BUNDLE,MSG_ERR_UNINSTALL_AND_RECOVER_NOT_PREINSTALLED_BUNDLE},
    ...
    {IStatusReceiver::ERR_USER_CREATE_FAILED,MSG_ERR_USER_CREATE_FAILED},
    {IStatusReceiver::ERR_USER_REMOVE_FAILED,MSG_ERR_USER_REMOVE_FAILED},
    ...
    {IStatusReceiver::ERR_APPEXECFWK_UNINSTALL_SHARE_APP_LIBRARY_IS_NOT_EXIST,MSG_ERR_UNINSTALL_SHARE_APP_LIBRARY_NOT_EXIST},
    {IStatusReceiver::ERR_APPEXECFWK_UNINSTALL_SHARE_APP_LIBRARY_IS_RELIED,MSG_ERR_UNINSTALL_SHARE_APP_LIBRARY_IS_RELIED},
    {IStatusReceiver::ERR_APPEXECFWK_UNINSTALL_BUNDLE_IS_SHARED_LIBRARY,MSG_ERR_UNINSTALL_BUNDLE_IS_SHAED_LIBRARY},
    ...
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_INTERNAL_ERROR,MSG_ERR_OVERLAY_INSTALLATION_FAILED_INTERNAL_ERROR},
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_INVALID_BUNDLE_NAME,MSG_ERR_OVERLAY_INSTALLATION_FAILED_INVALID_BUNDLE_NAME},
    ...
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_ERROR_BUNDLE_TYPE,MSG_ERR_OVERLAY_INSTALLATION_FAILED_ERROR_BUNDLE_TYPE},
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_TARGET_BUNDLE_NAME_MISSED,MSG_ERR_OVERLAY_INSTALLATION_FAILED_TARGET_BUNDLE_NAME_MISSED},
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_TARGET_MODULE_NAME_MISSED,MSG_ERR_OVERLAY_INSTALLATION_FAILED_TARGET_MODULE_NAME_MISSED},
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_TARGET_BUNDLE_NAME_NOT_SAME,MSG_ERR_OVERLAY_INSTALLATION_FAILED_TARGET_BUNDLE_NAME_NOT_SAME},
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_INTERNAL_EXTERNAL_OVERLAY_EXISTED_SIMULTANEOUSLY,MSG_ERR_OVERLAY_INSTALLATION_FAILED_INTERNAL_EXTERNAL_OVERLAY_EXISTED_SIMULTANEOUSLY},
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_TARGET_PRIORITY_NOT_SAME,MSG_ERR_OVERLAY_INSTALLATION_FAILED_TARGET_PRIORITY_NOT_SAME},
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_INVALID_PRIORITY,MSG_ERR_OVERLAY_INSTALLATION_FAILED_INVALID_PRIORITY},
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_INCONSISTENT_VERSION_CODE,MSG_ERR_OVERLAY_INSTALLATION_FAILED_INCONSISTENT_VERSION_CODE},
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_SERVICE_EXCEPTION,MSG_ERR_OVERLAY_INSTALLATION_FAILED_SERVICE_EXCEPTION},
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_BUNDLE_NAME_SAME_WITH_TARGET_BUNDLE_NAME,MSG_ERR_OVERLAY_INSTALLATION_FAILED_BUNDLE_NAME_SAME_WITH_TARGET_BUNDLE_NAME},
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_NO_SYSTEM_APPLICATION_FOR_EXTERNAL_OVERLAY,MSG_ERR_OVERLAY_INSTALLATION_FAILED_NO_SYSTEM_APPLICATION_FOR_EXTERNAL_OVERLAY},
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_DIFFERENT_SIGNATURE_CERTIFICATE,MSG_ERR_OVERLAY_INSTALLATION_FAILED_DIFFERENT_SIGNATURE_CERTIFICATE},
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_TARGET_BUNDLE_IS_OVERLAY_BUNDLE,MSG_ERR_OVERLAY_INSTALLATION_FAILED_TARGET_BUNDLE_IS_OVERLAY_BUNDLE},
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_TARGET_MODULE_IS_OVERLAY_MODULE,MSG_ERR_OVERLAY_INSTALLATION_FAILED_TARGET_MODULE_IS_OVERLAY_MODULE},
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_OVERLAY_TYPE_NOT_SAME,MSG_ERR_OVERLAY_INSTALLATION_FAILED_OVERLAY_TYPE_NOT_SAME},
    {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_INVALID_BUNDLE_DIR,MSG_ERR_OVERLAY_INSTALLATION_FAILED_INVALID_BUNDLE_DIR},
    {IStatusReceiver::ERR_INSATLL_CHECK_PROXY_DATA_URI_FAILED,MSG_ERR_INSTALL_PROXY_DATA_URI_WRONG},
    {IStatusReceiver::ERR_INSATLL_CHECK_PROXY_DATA_PERMISSION_FAILED,MSG_ERR_INSTALL_PROXY_DATA_PERMISSION_WRONG},
    ...
    {IStatusReceiver::ERR_INSTALL_SELF_UPDATE_BUNDLENAME_NOT_SAME,MSG_ERR_INSTALL_SELF_UPDATE_BUNDLENAME_NOT_SAME},
    {IStatusReceiver::ERR_INSTALL_ENTERPRISE_BUNDLE_NOT_ALLOWED,MSG_ERR_INSTALL_ENTERPRISE_BUNDLE_NOT_ALLOWED},
    ...
    {IStatusReceiver::ERR_INSTALL_CODE_SIGNATURE_DELIVERY_FILE_FAILED,MSG_ERR_INSTALL_CODE_SIGNATURE_DELIVERY_FILE_FAILED},
    {IStatusReceiver::ERR_INSTALL_CODE_SIGNATURE_REMOVE_FILE_FAILED,MSG_ERR_INSTALL_CODE_SIGNATURE_REMOVE_FILE_FAILED},
    {IStatusReceiver::ERR_INSTALL_CODE_APP_CONTROLLED_FAILED,MSG_ERR_INSTALL_CODE_APP_CONTROLLED_FAILED},
    {IStatusReceiver::ERR_INSTALL_CODE_APP_CONTROLLED_FAILED,MSG_ERR_INSTALL_CODE_APP_CONTROLLED_FAILED},
    {IStatusReceiver::ERR_UNINSTALL_CONTROLLED,MSG_ERR_UNINSTALL_CONTROLLED},
};
}  // namespace
...
void StatusReceiverProxy::TransformResult(const int32_t resultCode)
{
    ...
    for (size_t i = 0; i < sizeof(MAP_RECEIVED_RESULTS_KEY) / sizeof(MAP_RECEIVED_RESULTS_KEY[0]); i++) {
        if (resultCode == MAP_RECEIVED_RESULTS_KEY[i]) {
            resultCode_ = MAP_RECEIVED_RESULTS_VALUE[i].clientCode;
            resultMsg_ = MAP_RECEIVED_RESULTS_VALUE[i].clientMessage;
            break;
        }
    }
