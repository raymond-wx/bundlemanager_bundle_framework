...
const char* MSG_ERR_INSTALL_FAILED_SET_SHARE_FILES_FAIL = "[MSG_ERR_INSTALL_FAILED_SET_SHARE_FILES_FAIL]";
...
const std::unordered_map<int32_t, struct ReceivedResult> MAP_RECEIVED_RESULTS {
    ...
    {ERR_APPEXECFWK_INSTALL_FAILED_SET_SHARE_FILES_FAIL,
        {IStatusReceiver::ERR_INSTALL_FAILED_SET_SHARE_FILES_FAIL,
            MSG_ERR_INSTALL_FAILED_SET_SHARE_FILES_FAIL}},
};
}  // namespace
