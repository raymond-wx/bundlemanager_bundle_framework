...
const char* g_MSG_ERR_APPEXECFWK_INSTALL_DEBUG_NOT_SAME = "[MSG_ERR_APPEXECFWK_INSTALL_DEBUG_NOT_SAME]";
...
const std::map<int32_t, struct ReceivedResult> MAP_RECEIVED_RESULTS {
    ...
    {ERR_APPEXECFWK_INSTALL_DEBUG_NOT_SAME,
        {IStatusReceiver::ERR_INSTALL_FAILED_DEBUG_NOT_SAME, g_MSG_ERR_APPEXECFWK_INSTALL_DEBUG_NOT_SAME}},
};
}  // namespace
