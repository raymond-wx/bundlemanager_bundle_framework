...
const char* MSG_ERR_OVERLAY_INSTALLATION_FAILED_NO_PERMISSION_FOR_TARGET_BUNDLE =
    "[ERR_OVERLAY_INSTALLATION_FAILED_NO_PERMISSION_FOR_TARGET_BUNDLE]";
...
const std::map<int32_t, struct ReceivedResult> MAP_RECEIVED_RESULTS {
    ...
    {ERR_BUNDLEMANAGER_OVERLAY_INSTALLATION_FAILED_NO_PERMISSION_FOR_TARGET_BUNDLE,
        {IStatusReceiver::ERR_OVERLAY_INSTALLATION_FAILED_NO_PERMISSION_FOR_TARGET_BUNDLE,
            MSG_ERR_OVERLAY_INSTALLATION_FAILED_NO_PERMISSION_FOR_TARGET_BUNDLE}},
