...
namespace {
// event type
const char* BUNDLE_INSTALL_EXCEPTION = "BUNDLE_INSTALL_EXCEPTION";
const char* BUNDLE_UNINSTALL_EXCEPTION = "BUNDLE_UNINSTALL_EXCEPTION";
const char* BUNDLE_UPDATE_EXCEPTION = "BUNDLE_UPDATE_EXCEPTION";
const char* PRE_BUNDLE_RECOVER_EXCEPTION = "PRE_BUNDLE_RECOVER_EXCEPTION";
const char* BUNDLE_STATE_CHANGE_EXCEPTION = "BUNDLE_STATE_CHANGE_EXCEPTION";
const char* BUNDLE_CLEAN_CACHE_EXCEPTION = "BUNDLE_CLEAN_CACHE_EXCEPTION";

const char* BOOT_SCAN_START = "BOOT_SCAN_START";
const char* BOOT_SCAN_END = "BOOT_SCAN_END";
const char* BUNDLE_INSTALL = "BUNDLE_INSTALL";
const char* BUNDLE_UNINSTALL = "BUNDLE_UNINSTALL";
const char* BUNDLE_UPDATE = "BUNDLE_UPDATE";
const char* PRE_BUNDLE_RECOVER = "PRE_BUNDLE_RECOVER";
const char* BUNDLE_STATE_CHANGE = "BUNDLE_STATE_CHANGE";
const char* BUNDLE_CLEAN_CACHE = "BUNDLE_CLEAN_CACHE";
const char* BMS_USER_EVENT = "BMS_USER_EVENT";
const char* BUNDLE_QUICK_FIX = "BUNDLE_QUICK_FIX";
const char* CPU_SCENE_ENTRY = "CPU_SCENE_ENTRY";
const char* FREE_INSTALL_EVENT = "FREE_INSTALL_EVENT";
static constexpr char PERFORMANCE_DOMAIN[] = "PERFORMANCE";
static constexpr char BUNDLE_MANAGER[] = "BUNDLE_MANAGER";
const char* AOT_COMPILE_SUMMARY = "AOT_COMPILE_SUMMARY";
const char* AOT_COMPILE_RECORD = "AOT_COMPILE_RECORD";
const char* QUERY_OF_CONTINUE_TYPE = "QUERY_OF_CONTINUE_TYPE";
