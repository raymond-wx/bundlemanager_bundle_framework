...
const std::string HAP_NAME_ENTRY_A = "dependencies_entry_A.hsp";
...
const std::string MODULE_NAME_ENTRY_A = "dependencies_entry_A";
const std::string MODULE_NAME_ENTRY_B = "dependencies_entry_B";
const std::string MODULE_NAME_ENTRY_C = "dependencies_entry_C";
...
std::shared_ptr<BundleMgrService> BmsBundleDependenciesTest::bundleMgrService_ =
    DelayedSingleton<BundleMgrService>::GetInstance();

std::shared_ptr<InstalldService> BmsBundleDependenciesTest::installdService_ =
