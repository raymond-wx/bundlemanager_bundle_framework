...
const std::string NON_DRIVER_FEATURE_BUNDLE = "non_driver_feature_hap.hap";
const std::string NON_DRIVER_FEATURE1_BUNDLE = "non_driver_feature1_hap.hap";
const std::string NON_DRIVER_FEATURE2_BUNDLE = "non_driver_feature2_hap.hap";
const std::string NON_DRIVER_FEATURE3_BUNDLE = "non_driver_feature3_hap.hap";
const std::string NON_DRIVER_FEATURE4_BUNDLE = "non_driver_feature4_hap.hap";
const std::string NON_DRIVER_FEATURE5_BUNDLE = "non_driver_feature5_hap.hap";
const std::string NON_DRIVER_FEATURE6_BUNDLE = "non_driver_feature6_hap.hap";
...
{
    std::vector<std::string> bundleFileVec = { RESOURCE_ROOT_PATH + NON_DRIVER_FEATURE_BUNDLE };
    ErrCode result = InstallBundle(bundleFileVec);
    EXPECT_EQ(result, ERR_OK);
    CheckBundleDirExist();
    CheckModuleDirExist();
...
{
    std::vector<std::string> bundleFileVec = { RESOURCE_ROOT_PATH + NON_DRIVER_FEATURE1_BUNDLE };
    ErrCode result = InstallBundle(bundleFileVec);
    EXPECT_EQ(result, ERR_OK);
    CheckBundleDirExist();
    CheckModuleDirExist();
...
{
    std::vector<std::string> bundleFileVec = { RESOURCE_ROOT_PATH + NON_DRIVER_FEATURE2_BUNDLE };
    ErrCode result = InstallBundle(bundleFileVec);
...
{
    std::vector<std::string> bundleFileVec = { RESOURCE_ROOT_PATH + NON_DRIVER_FEATURE3_BUNDLE };
    ErrCode result = InstallBundle(bundleFileVec);
    EXPECT_EQ(result, ERR_APPEXECFWK_INSTALLD_COPY_FILE_FAILED);
}
...
{
    std::vector<std::string> bundleFileVec = { RESOURCE_ROOT_PATH + NON_DRIVER_FEATURE4_BUNDLE };
    ErrCode result = InstallBundle(bundleFileVec);
    EXPECT_EQ(result, ERR_APPEXECFWK_INSTALLD_COPY_FILE_FAILED);
}
...
{
    std::vector<std::string> bundleFileVec = { RESOURCE_ROOT_PATH + NON_DRIVER_FEATURE5_BUNDLE };
    ErrCode result = InstallBundle(bundleFileVec);
    EXPECT_EQ(result, ERR_APPEXECFWK_INSTALLD_COPY_FILE_FAILED);
}
...
{
    std::vector<std::string> bundleFileVec = { RESOURCE_ROOT_PATH + NON_DRIVER_FEATURE6_BUNDLE };
    ErrCode result = InstallBundle(bundleFileVec);
    EXPECT_EQ(result, ERR_OK);
    CheckBundleDirExist();
    CheckModuleDirExist();
...
{
    std::vector<std::string> bundleFileVec = { RESOURCE_ROOT_PATH + NON_DRIVER_ENTRY_BUNDLE,
        RESOURCE_ROOT_PATH + NON_DRIVER_FEATURE_BUNDLE };
    ErrCode result = InstallBundle(bundleFileVec);
    EXPECT_EQ(result, ERR_OK);
    CheckBundleDirExist();
    CheckModuleDirExist();
...
{
    std::vector<std::string> bundleFileVec = { RESOURCE_ROOT_PATH + NON_DRIVER_ENTRY_BUNDLE,
        RESOURCE_ROOT_PATH + NON_DRIVER_FEATURE1_BUNDLE };
    ErrCode result = InstallBundle(bundleFileVec);
    EXPECT_EQ(result, ERR_OK);
    CheckBundleDirExist();
    CheckModuleDirExist();
...
{
    std::vector<std::string> bundleFileVec = { RESOURCE_ROOT_PATH + NON_DRIVER_ENTRY_BUNDLE,
        RESOURCE_ROOT_PATH + NON_DRIVER_FEATURE2_BUNDLE };
    ErrCode result = InstallBundle(bundleFileVec);
    EXPECT_EQ(result, ERR_APPEXECFWK_INSTALLD_COPY_FILE_FAILED);
}
...
{
    std::vector<std::string> bundleFileVec = { RESOURCE_ROOT_PATH + NON_DRIVER_ENTRY_BUNDLE,
        RESOURCE_ROOT_PATH + NON_DRIVER_FEATURE3_BUNDLE };
    ErrCode result = InstallBundle(bundleFileVec);
    EXPECT_EQ(result, ERR_APPEXECFWK_INSTALLD_COPY_FILE_FAILED);
}
...
{
    std::vector<std::string> bundleFileVec = { RESOURCE_ROOT_PATH + NON_DRIVER_ENTRY_BUNDLE,
        RESOURCE_ROOT_PATH + NON_DRIVER_FEATURE4_BUNDLE };
    ErrCode result = InstallBundle(bundleFileVec);
    EXPECT_EQ(result, ERR_APPEXECFWK_INSTALLD_COPY_FILE_FAILED);
}
...
{
    std::vector<std::string> bundleFileVec = { RESOURCE_ROOT_PATH + NON_DRIVER_ENTRY_BUNDLE,
        RESOURCE_ROOT_PATH + NON_DRIVER_FEATURE5_BUNDLE };
    ErrCode result = InstallBundle(bundleFileVec);
    EXPECT_EQ(result, ERR_APPEXECFWK_INSTALLD_COPY_FILE_FAILED);
}
...
{
    std::vector<std::string> bundleFileVec = { RESOURCE_ROOT_PATH + NON_DRIVER_ENTRY_BUNDLE,
        RESOURCE_ROOT_PATH + NON_DRIVER_FEATURE6_BUNDLE };
    ErrCode result = InstallBundle(bundleFileVec);
    bool isDirEmpty = IsDriverDirEmpty();
    EXPECT_FALSE(isDirEmpty);
    // /data/service/el1/public/print_service/cups/datadir/model/com.example.driverTest_feature6_main_pages.json
